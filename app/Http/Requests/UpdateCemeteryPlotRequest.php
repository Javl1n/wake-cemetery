...
class UpdateCemeteryPlotRequest extends FormRequest
{
    /**
    ...
    {
        return $this->user()->can('update', $this->route('cemetery_plot'));
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'plot_number' => [
                ...
                'string',
                'max:255',
                Rule::unique('cemetery_plots', 'plot_number')->ignore($this->route('cemetery_plot')),
            ],
